...
namespace BenpilsBarcodeSystem {
    ...
    public partial class UserCredentialsDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/UserCredentialsDataSet.xsd";
        ...
        public partial class tbl_loginDataTable : global::System.Data.TypedTableBase<tbl_loginRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public tbl_loginRow Addtbl_loginRow(string firstname, string lastname, string username, string password, string designation, string address, string contactnumber) {
        ...
        public partial class tbl_loginRow : global::System.Data.DataRow {
            ...
            public string contactnumber {
                get {
                    try {
                        return ((string)(this[this.tabletbl_login.contactnumberColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'contactnumber\' in table \'tbl_login\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tabletbl_login.contactnumberColumn] = value;
                }
            }
            ...
            public bool IscontactnumberNull() {
                return this.IsNull(this.tabletbl_login.contactnumberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetcontactnumberNull() {
                this[this.tabletbl_login.contactnumberColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace BenpilsBarcodeSystem.UserCredentialsDataSetTableAdapters {
    ...
    public partial class tbl_loginTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[tbl_login] WHERE (([id] = @Original_id) AND ((@IsNull_firstname = 1 AND [firstname] IS NULL) OR ([firstname] = @Original_firstname)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_designation = 1 AND [designation] IS NULL) OR ([designation] = @Original_designation)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_contactnumber = 1 AND [contactnumber] IS NULL) OR ([contactnumber] = @Original_contactnumber)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[tbl_login] ([firstname], [lastname], [username], [password], [designation], [address], [contactnumber]) VALUES (@firstname, @lastname, @username, @password, @designation, @address, @contactnumber);
SELECT id, firstname, lastname, username, password, designation, address, contactnumber FROM tbl_login WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_login] SET [firstname] = @firstname, [lastname] = @lastname, [username] = @username, [password] = @password, [designation] = @designation, [address] = @address, [contactnumber] = @contactnumber WHERE (([id] = @Original_id) AND ((@IsNull_firstname = 1 AND [firstname] IS NULL) OR ([firstname] = @Original_firstname)) AND ((@IsNull_lastname = 1 AND [lastname] IS NULL) OR ([lastname] = @Original_lastname)) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)) AND ((@IsNull_designation = 1 AND [designation] IS NULL) OR ([designation] = @Original_designation)) AND ((@IsNull_address = 1 AND [address] IS NULL) OR ([address] = @Original_address)) AND ((@IsNull_contactnumber = 1 AND [contactnumber] IS NULL) OR ([contactnumber] = @Original_contactnumber)));
SELECT id, firstname, lastname, username, password, designation, address, contactnumber FROM tbl_login WHERE (id = @id)";
        ...
        public virtual int Delete(int Original_id, string Original_firstname, string Original_lastname, string Original_username, string Original_password, string Original_designation, string Original_address, string Original_contactnumber) {
        ...
        public virtual int Insert(string firstname, string lastname, string username, string password, string designation, string address, string contactnumber) {
            if ((firstname == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string firstname, string lastname, string username, string password, string designation, string address, string contactnumber, int Original_id, string Original_firstname, string Original_lastname, string Original_username, string Original_password, string Original_designation, string Original_address, string Original_contactnumber) {
            return this.Update(firstname, lastname, username, password, designation, address, contactnumber, Original_id, Original_firstname, Original_lastname, Original_username, Original_password, Original_designation, Original_address, Original_contactnumber, Original_id);
        }
    }
